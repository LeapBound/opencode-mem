...
Filesystem analysis of `~/.claude/projects/-Users-alexnewman-Scripts-opencode-mem/`:
...
The .jsonl files are created by the **Claude Agent SDK** (`@anthropic-ai/claude-agent-sdk`), not by opencode-mem directly.
