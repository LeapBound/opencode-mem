...
The Worker Service is an Express HTTP server that handles all opencode-mem operations. It runs on port 37777 (configurable via `OPENCODE_MEM_WORKER_PORT`) and is managed by PM2.
