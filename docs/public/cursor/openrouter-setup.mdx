...
description: "Use OpenCode-Mem in Cursor with OpenRouter's 100+ AI models"
---

# Cursor + OpenRouter Setup

This guide walks you through setting up OpenCode-Mem in Cursor using OpenRouter. OpenRouter provides access to 100+ AI models from various providers, including several free options.
...
## Step 2: Clone and Build OpenCode-Mem
...
cat > ~/.opencode-mem/settings.json << 'EOF'
{
  ...
  "OPENCODE_MEM_OPENROUTER_API_KEY": "YOUR_OPENROUTER_API_KEY"
}
EOF
```
...
{
  "OPENCODE_MEM_PROVIDER": "openrouter",
  "OPENCODE_MEM_OPENROUTER_API_KEY": "your-key",
  "OPENCODE_MEM_OPENROUTER_MODEL": "google/gemini-2.0-flash-exp:free"
}
```
...
{
  "OPENCODE_MEM_PROVIDER": "openrouter",
  "OPENCODE_MEM_OPENROUTER_API_KEY": "sk-or-..."
}
```
