...
2. **Redundant HTML comment** - "<!-- This section is auto-generated by opencode-mem. Edit content outside the tags. -->" is unnecessary since the `<opencode-mem-context>` tag already conveys this information
...
This will:
- Find all CLAUDE.md files with `<opencode-mem-context>` tags
...
- `grep -r "auto-generated by opencode-mem" . --include="CLAUDE.md"` should return no results
