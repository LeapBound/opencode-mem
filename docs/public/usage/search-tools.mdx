...
Instead of fetching all historical data upfront (expensive), opencode-mem uses a progressive disclosure approach:
...
**Database:** SQLite FTS5 full-text search on `~/.opencode-mem/opencode-mem.db`
