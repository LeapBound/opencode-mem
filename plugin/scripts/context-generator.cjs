"use strict";var ut=Object.create;var P=Object.defineProperty;var lt=Object.getOwnPropertyDescriptor;var Et=Object.getOwnPropertyNames;var Tt=Object.getPrototypeOf,gt=Object.prototype.hasOwnProperty;var Ot=(r,e)=>{for(var t in e)P(r,t,{get:e[t],enumerable:!0})},re=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Et(e))!gt.call(r,n)&&n!==t&&P(r,n,{get:()=>e[n],enumerable:!(s=lt(e,n))||s.enumerable});return r};var w=(r,e,t)=>(t=r!=null?ut(Tt(r)):{},re(e||!r||!r.__esModule?P(t,"default",{value:r,enumerable:!0}):t,r)),ft=r=>re(P({},"__esModule",{value:!0}),r);var kt={};Ot(kt,{generateContext:()=>se});module.exports=ft(kt);var ct=w(require("path"),1),mt=require("os"),_t=require("fs");var Te=require("bun:sqlite");var S=require("path"),pe=require("os"),ce=require("fs");var me=require("url");var N=require("fs"),v=require("path"),H=require("os");var ne="bugfix,feature,refactor,discovery,decision,change",oe="how-it-works,why-it-exists,what-changed,problem-solution,gotcha,pattern,trade-off";var St=(0,v.join)((0,H.homedir)(),".opencode-mem"),ie=(0,v.join)(St,"settings.json"),y=class{static DEFAULTS={OPENCODE_MEM_MODEL:"claude-sonnet-4-5",OPENCODE_MEM_CONTEXT_OBSERVATIONS:"50",OPENCODE_MEM_WORKER_PORT:"37777",OPENCODE_MEM_WORKER_HOST:"127.0.0.1",OPENCODE_MEM_SKIP_TOOLS:"ListMcpResourcesTool,SlashCommand,Skill,TodoWrite,AskUserQuestion",OPENCODE_MEM_PROVIDER:"claude",OPENCODE_MEM_CLAUDE_AUTH_METHOD:"cli",OPENCODE_MEM_GEMINI_API_KEY:"",OPENCODE_MEM_GEMINI_MODEL:"gemini-2.5-flash-lite",OPENCODE_MEM_GEMINI_RATE_LIMITING_ENABLED:"true",OPENCODE_MEM_OPENROUTER_API_KEY:"",OPENCODE_MEM_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",OPENCODE_MEM_OPENROUTER_SITE_URL:"",OPENCODE_MEM_OPENROUTER_APP_NAME:"opencode-mem",OPENCODE_MEM_OPENROUTER_MAX_CONTEXT_MESSAGES:"20",OPENCODE_MEM_OPENROUTER_MAX_TOKENS:"100000",OPENCODE_MEM_DATA_DIR:(0,v.join)((0,H.homedir)(),".opencode-mem"),OPENCODE_MEM_LOG_LEVEL:"INFO",OPENCODE_MEM_PYTHON_VERSION:"3.13",CLAUDE_CODE_PATH:"",OPENCODE_MEM_MODE:"code",OPENCODE_MEM_CONTEXT_SHOW_READ_TOKENS:"true",OPENCODE_MEM_CONTEXT_SHOW_WORK_TOKENS:"true",OPENCODE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT:"true",OPENCODE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT:"true",OPENCODE_MEM_CONTEXT_OBSERVATION_TYPES:ne,OPENCODE_MEM_CONTEXT_OBSERVATION_CONCEPTS:oe,OPENCODE_MEM_CONTEXT_FULL_COUNT:"5",OPENCODE_MEM_CONTEXT_FULL_FIELD:"narrative",OPENCODE_MEM_CONTEXT_SESSION_COUNT:"10",OPENCODE_MEM_CONTEXT_SHOW_LAST_SUMMARY:"true",OPENCODE_MEM_CONTEXT_SHOW_LAST_MESSAGE:"false",OPENCODE_MEM_FOLDER_CLAUDEMD_ENABLED:"false",OPENCODE_MEM_EXCLUDED_PROJECTS:"",OPENCODE_MEM_FOLDER_MD_EXCLUDE:"[]"};static getAllDefaults(){return{...this.DEFAULTS}}static get(e){return e==="OPENCODE_MEM_DATA_DIR"?this.resolveDataDir():this.DEFAULTS[e]}static resolveDataDir(){let e=process.env.OPENCODE_MEM_DATA_DIR;if(e&&e.trim())return e.trim();try{if((0,N.existsSync)(ie)){let t=(0,N.readFileSync)(ie,"utf-8"),n=JSON.parse(t).OPENCODE_MEM_DATA_DIR;if(typeof n=="string"&&n.trim())return n.trim()}}catch{}return this.DEFAULTS.OPENCODE_MEM_DATA_DIR}static getInt(e){let t=this.get(e);return parseInt(t,10)}static getBool(e){return this.get(e)==="true"}static applyEnvOverrides(e){let t={...e};for(let s of Object.keys(this.DEFAULTS))process.env[s]!==void 0&&(t[s]=process.env[s]);return t}static loadFromFile(e){try{if(!(0,N.existsSync)(e)){let i=this.getAllDefaults();try{let a=(0,v.dirname)(e);(0,N.existsSync)(a)||(0,N.mkdirSync)(a,{recursive:!0}),(0,N.writeFileSync)(e,JSON.stringify(i,null,2),"utf-8"),process.stderr.write(`[SETTINGS] Created settings file with defaults: ${e}
`)}catch(a){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,a)}return this.applyEnvOverrides(i)}let t=(0,N.readFileSync)(e,"utf-8"),s=JSON.parse(t),n=s;if(s.env&&typeof s.env=="object"){n=s.env;try{(0,N.writeFileSync)(e,JSON.stringify(n,null,2),"utf-8"),process.stderr.write(`[SETTINGS] Migrated settings file from nested to flat schema: ${e}
`)}catch(i){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,i)}}let o={...this.DEFAULTS};for(let i of Object.keys(this.DEFAULTS))n[i]!==void 0&&(o[i]=n[i]);return this.applyEnvOverrides(o)}catch(t){return console.warn("[SETTINGS] Failed to load settings, using defaults:",e,t),this.applyEnvOverrides(this.getAllDefaults())}}};var C=require("fs"),M=require("path"),de=require("os"),W=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(W||{}),ae=(0,M.join)((0,de.homedir)(),".opencode-mem"),V=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,M.join)(ae,"logs");(0,C.existsSync)(e)||(0,C.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,M.join)(e,`opencode-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,M.join)(ae,"settings.json");if((0,C.existsSync)(e)){let t=(0,C.readFileSync)(e,"utf-8"),n=(JSON.parse(t).OPENCODE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=W[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=W[e].padEnd(5),d=t.padEnd(6),c="";n?.correlationId?c=`[${n.correlationId}] `:n?.sessionId&&(c=`[session-${n.sessionId}] `);let _="";o!=null&&(o instanceof Error?_=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`:this.getLevel()===0&&typeof o=="object"?_=`
`+JSON.stringify(o,null,2):_=" "+this.formatData(o));let u="";if(n){let{sessionId:E,memorySessionId:g,correlationId:b,...l}=n;Object.keys(l).length>0&&(u=` {${Object.entries(l).map(([O,R])=>`${O}=${R}`).join(", ")}}`)}let T=`[${i}] [${a}] [${d}] ${c}${s}${u}${_}`;if(this.logFilePath)try{(0,C.appendFileSync)(this.logFilePath,T+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),_=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",u={...s,location:_};return this.warn(e,`[HAPPY-PATH] ${t}`,u,n),o}},m=new V;var Nt={};function bt(){return typeof __dirname<"u"?__dirname:(0,S.dirname)((0,me.fileURLToPath)(Nt.url))}var ht=bt(),I=y.get("OPENCODE_MEM_DATA_DIR"),A=process.env.CLAUDE_CONFIG_DIR||(0,S.join)((0,pe.homedir)(),".claude"),Ht=(0,S.join)(A,"plugins","marketplaces","thedotmack"),Wt=(0,S.join)(I,"archives"),Vt=(0,S.join)(I,"logs"),Yt=(0,S.join)(I,"trash"),qt=(0,S.join)(I,"backups"),Kt=(0,S.join)(I,"modes"),_e=(0,S.join)(I,"settings.json"),ue=(0,S.join)(I,"opencode-mem.db"),Jt=(0,S.join)(I,"vector-db"),zt=(0,S.join)(I,"observer-sessions"),Qt=(0,S.join)(A,"settings.json"),Zt=(0,S.join)(A,"commands"),es=(0,S.join)(A,"CLAUDE.md");function le(r){(0,ce.mkdirSync)(r,{recursive:!0})}function Ee(){return(0,S.join)(ht,"..")}var $=class{db;constructor(e=ue){e!==":memory:"&&le(I),this.db=new Te.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys()}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,c=s==="date_asc"?"ASC":"DESC",_=n?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),T=[...e],E=[];if(o&&(E.push("project = ?"),T.push(o)),i)if(Array.isArray(i)){let l=i.map(()=>"?").join(",");E.push(`type IN (${l})`),T.push(...i)}else E.push("type = ?"),T.push(i);if(a){let l=Array.isArray(a)?a:[a],f=l.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");T.push(...l),E.push(`(${f.join(" OR ")})`)}if(d){let l=Array.isArray(d)?d:[d],f=l.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");l.forEach(O=>{T.push(`%${O}%`,`%${O}%`)}),E.push(`(${f.join(" OR ")})`)}let g=E.length>0?`WHERE id IN (${u}) AND ${E.join(" AND ")}`:`WHERE id IN (${u})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${g}
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(_.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a){let d=a??Date.now(),c=new Date(d).toISOString();return this.db.transaction(()=>{let u=[],T=this.db.prepare(`
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let g of s){let b=T.run(e,t,g.type,g.title,g.subtitle,JSON.stringify(g.facts),g.narrative,JSON.stringify(g.concepts),JSON.stringify(g.files_read),JSON.stringify(g.files_modified),o||null,i,c,d);u.push(Number(b.lastInsertRowid))}let E=null;if(n){let b=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,c,d);E=Number(b.lastInsertRowid)}return{observationIds:u,summaryId:E,createdAtEpoch:d}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,c){let _=c??Date.now(),u=new Date(_).toISOString();return this.db.transaction(()=>{let E=[],g=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let f of s){let O=g.run(e,t,f.type,f.title,f.subtitle,JSON.stringify(f.facts),f.narrative,JSON.stringify(f.concepts),JSON.stringify(f.files_read),JSON.stringify(f.files_modified),a||null,d,u,_);E.push(Number(O.lastInsertRowid))}let b;if(n){let O=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,u,_);b=Number(O.lastInsertRowid)}return this.db.prepare(`
      ...
      `).run(_,o),{observationIds:E,summaryId:b,createdAtEpoch:_}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="date_asc"?"ASC":"DESC",a=n?`LIMIT ${n}`:"",d=e.map(()=>"?").join(","),c=[...e],_=o?`WHERE id IN (${d}) AND project = ?`:`WHERE id IN (${d})`;return o&&c.push(o),this.db.prepare(`
    ...
    `).all(...c)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,c;if(e!==null){let l=`
      ...
      `,f=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let O=this.db.prepare(l).all(e,...a,s+1),R=this.db.prepare(f).all(e,...a,n+1);if(O.length===0&&R.length===0)return{observations:[],sessions:[],prompts:[]};d=O.length>0?O[O.length-1].created_at_epoch:t,c=R.length>0?R[R.length-1].created_at_epoch:t}catch(O){return m.error("DB","Error getting boundary observations",void 0,{error:O,project:o}),{observations:[],sessions:[],prompts:[]}}}else{let l=`
      ...
      `,f=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let O=this.db.prepare(l).all(t,...a,s),R=this.db.prepare(f).all(t,...a,n+1);if(O.length===0&&R.length===0)return{observations:[],sessions:[],prompts:[]};d=O.length>0?O[O.length-1].created_at_epoch:t,c=R.length>0?R[R.length-1].created_at_epoch:t}catch(O){return m.error("DB","Error getting boundary timestamps",void 0,{error:O,project:o}),{observations:[],sessions:[],prompts:[]}}}let _=`
      SELECT *
      FROM observations
    ...
    `).run(e.content_session_id,e.prompt_number,e.prompt_text,e.created_at,e.created_at_epoch).lastInsertRowid}}};var ge=w(require("path"),1);function Oe(r){if(!r||r.trim()==="")return m.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=ge.default.basename(r);if(e===""){if(process.platform==="win32"){let s=r.match(/^([A-Z]):\\/i);if(s){let o=`drive-${s[1].toUpperCase()}`;return m.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:o}),o}}return m.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return e}var L=require("fs"),F=require("path");var h=class r{static instance=null;activeMode=null;modesDir;constructor(){let e=Ee(),t=[(0,F.join)(e,"modes"),(0,F.join)(e,"..","plugin","modes")],s=t.find(n=>(0,L.existsSync)(n));this.modesDir=s||t[0]}static getInstance(){return r.instance||(r.instance=new r),r.instance}parseInheritance(e){let t=e.split("--");if(t.length===1)return{hasParent:!1,parentId:"",overrideId:""};if(t.length>2)throw new Error(`Invalid mode inheritance: ${e}. Only one level of inheritance supported (parent--override)`);return{hasParent:!0,parentId:t[0],overrideId:e}}isPlainObject(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}deepMerge(e,t){let s={...e};for(let n in t){let o=t[n],i=e[n];this.isPlainObject(o)&&this.isPlainObject(i)?s[n]=this.deepMerge(i,o):s[n]=o}return s}loadModeFile(e){let t=(0,F.join)(this.modesDir,`${e}.json`);if(!(0,L.existsSync)(t))throw new Error(`Mode file not found: ${t}`);let s=(0,L.readFileSync)(t,"utf-8");return JSON.parse(s)}loadMode(e){let t=this.parseInheritance(e);if(!t.hasParent)try{let d=this.loadModeFile(e);return this.activeMode=d,m.debug("SYSTEM",`Loaded mode: ${d.name} (${e})`,void 0,{types:d.observation_types.map(c=>c.id),concepts:d.observation_concepts.map(c=>c.id)}),d}catch{if(m.warn("SYSTEM",`Mode file not found: ${e}, falling back to 'code'`),e==="code")throw new Error("Critical: code.json mode file missing");return this.loadMode("code")}let{parentId:s,overrideId:n}=t,o;try{o=this.loadMode(s)}catch{m.warn("SYSTEM",`Parent mode '${s}' not found for ${e}, falling back to 'code'`),o=this.loadMode("code")}let i;try{i=this.loadModeFile(n),m.debug("SYSTEM",`Loaded override file: ${n} for parent ${s}`)}catch{return m.warn("SYSTEM",`Override file '${n}' not found, using parent mode '${s}' only`),this.activeMode=o,o}if(!i)return m.warn("SYSTEM",`Invalid override file: ${n}, using parent mode '${s}' only`),this.activeMode=o,o;let a=this.deepMerge(o,i);return this.activeMode=a,m.debug("SYSTEM",`Loaded mode with inheritance: ${a.name} (${e} = ${s} + ${n})`,void 0,{parent:s,override:n,types:a.observation_types.map(d=>d.id),concepts:a.observation_concepts.map(d=>d.id)}),a}getActiveMode(){if(!this.activeMode)throw new Error("No mode loaded. Call loadMode() first.");return this.activeMode}getObservationTypes(){return this.getActiveMode().observation_types}getObservationConcepts(){return this.getActiveMode().observation_concepts}getTypeIcon(e){return this.getObservationTypes().find(s=>s.id===e)?.emoji||"\u{1F4DD}"}getWorkEmoji(e){return this.getObservationTypes().find(s=>s.id===e)?.work_emoji||"\u{1F4DD}"}validateType(e){return this.getObservationTypes().some(t=>t.id===e)}getTypeLabel(e){return this.getObservationTypes().find(s=>s.id===e)?.label||e}};function Y(){let r=y.loadFromFile(_e),e=r.OPENCODE_MEM_MODE,t=e==="code"||e.startsWith("code--"),s,n;if(t)s=new Set(r.OPENCODE_MEM_CONTEXT_OBSERVATION_TYPES.split(",").map(o=>o.trim()).filter(Boolean)),n=new Set(r.OPENCODE_MEM_CONTEXT_OBSERVATION_CONCEPTS.split(",").map(o=>o.trim()).filter(Boolean));else{let o=h.getInstance().getActiveMode();s=new Set(o.observation_types.map(i=>i.id)),n=new Set(o.observation_concepts.map(i=>i.id))}return{totalObservationCount:parseInt(r.OPENCODE_MEM_CONTEXT_OBSERVATIONS,10),fullObservationCount:parseInt(r.OPENCODE_MEM_CONTEXT_FULL_COUNT,10),sessionCount:parseInt(r.OPENCODE_MEM_CONTEXT_SESSION_COUNT,10),showReadTokens:r.OPENCODE_MEM_CONTEXT_SHOW_READ_TOKENS==="true",showWorkTokens:r.OPENCODE_MEM_CONTEXT_SHOW_WORK_TOKENS==="true",showSavingsAmount:r.OPENCODE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT==="true",showSavingsPercent:r.OPENCODE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT==="true",observationTypes:s,observationConcepts:n,fullObservationField:r.OPENCODE_MEM_CONTEXT_FULL_FIELD,showLastSummary:r.OPENCODE_MEM_CONTEXT_SHOW_LAST_SUMMARY==="true",showLastMessage:r.OPENCODE_MEM_CONTEXT_SHOW_LAST_MESSAGE==="true"}}var p={reset:"\x1B[0m",bright:"\x1B[1m",dim:"\x1B[2m",cyan:"\x1B[36m",green:"\x1B[32m",yellow:"\x1B[33m",blue:"\x1B[34m",magenta:"\x1B[35m",gray:"\x1B[90m",red:"\x1B[31m"},fe=4,q=1;function K(r){let e=(r.title?.length||0)+(r.subtitle?.length||0)+(r.narrative?.length||0)+JSON.stringify(r.facts||[]).length;return Math.ceil(e/fe)}function J(r){let e=r.length,t=r.reduce((i,a)=>i+K(a),0),s=r.reduce((i,a)=>i+(a.discovery_tokens||0),0),n=s-t,o=s>0?Math.round(n/s*100):0;return{totalObservations:e,totalReadTokens:t,totalDiscoveryTokens:s,savings:n,savingsPercent:o}}function Rt(r){return h.getInstance().getWorkEmoji(r)}function D(r,e){let t=K(r),s=r.discovery_tokens||0,n=Rt(r.type),o=s>0?`${n} ${s.toLocaleString()}`:"-";return{readTokens:t,discoveryTokens:s,discoveryDisplay:o,workEmoji:n}}function U(r){return r.showReadTokens||r.showWorkTokens||r.showSavingsAmount||r.showSavingsPercent}var Se=w(require("path"),1),X=require("fs");function z(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
  ...
  `).all(e,...s,...o,t.totalObservationCount)}function Q(r,e,t){return r.db.prepare(`
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(e,t.sessionCount+q)}function be(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      id, memory_session_id, type, title, subtitle, narrative,
      facts, concepts, files_read, files_modified, discovery_tokens,
...
`}function Ze(r,e,t,s){let n=[];return s?n.push(...Xe(r)):n.push(...Ce(r)),s?n.push(...je()):n.push(...ye()),s?n.push(...Ge()):n.push(...ve()),s?n.push(...Be()):n.push(...Ae()),U(t)&&(s?n.push(...He(e,t)):n.push(...De(e,t))),n}var te=w(require("path"),1);function B(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return m.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function tt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function st(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function rt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function et(r,e){return te.default.isAbsolute(r)?te.default.relative(e,r):r}function nt(r,e,t){let s=B(r);if(s.length>0)return et(s[0],e);if(t){let n=B(t);if(n.length>0)return et(n[0],e)}return"General"}function yt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=rt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function vt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?B(r.facts).join(`
`):null}function At(r,e,t,s,n,o){let i=[];o?i.push(...We(r)):i.push(...Me(r));let a=null,d="",c=!1;for(let _ of e)if(_.type==="summary"){c&&(i.push(""),c=!1,a=null,d="");let u=_.data,T=tt(u.displayTime);o?i.push(...Ke(u,T)):i.push(...Pe(u,T))}else{let u=_.data,T=nt(u.files_modified,n,u.files_read),E=st(u.created_at),g=E!==d,b=g?E:"";d=E;let l=t.has(u.id);if(T!==a&&(c&&i.push(""),o?i.push(...Ve(T)):i.push(...Le(T)),a=T,c=!0),l){let f=vt(u,s);o?i.push(...qe(u,E,g,f,s)):(c&&!o&&(i.push(""),c=!1),i.push(...ke(u,b,f,s)),a=null)}else o?i.push(Ye(u,E,g,s)):i.push(xe(u,b,s))}return c&&i.push(""),i}function ot(r,e,t,s,n){let o=[],i=yt(r);for(let[a,d]of i)o.push(...At(a,d,e,t,s,n));return o}function it(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function at(r,e){let t=[];return e?(t.push(...k("Investigated",r.investigated,p.blue)),t.push(...k("Learned",r.learned,p.yellow)),t.push(...k("Completed",r.completed,p.green)),t.push(...k("Next Steps",r.next_steps,p.magenta))):(t.push(...x("Investigated",r.investigated)),t.push(...x("Learned",r.learned)),t.push(...x("Completed",r.completed)),t.push(...x("Next Steps",r.next_steps))),t}function dt(r,e){return e?Je(r):we(r)}function pt(r,e,t){return!U(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?ze(r.totalDiscoveryTokens,r.totalReadTokens):$e(r.totalDiscoveryTokens,r.totalReadTokens)}var Dt=ct.default.join((0,mt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Mt(){try{return new $}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,_t.unlinkSync)(Dt)}catch(e){m.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return m.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Lt(r,e){return e?Qe(r):Fe(r)}function xt(r,e,t,s,n,o,i){let a=[],d=J(e);a.push(...Ze(r,d,s,i));let c=t.slice(0,s.sessionCount),_=Ne(c,t),u=ee(e,_),T=Re(e,s.fullObservationCount);a.push(...ot(u,T,s,n,i));let E=t[0],g=e[0];it(s,E,g)&&a.push(...at(E,i));let b=Z(e,s,o,n);return a.push(...dt(b,i)),a.push(...pt(d,s,i)),a.join(`
`).trimEnd()}async function se(r,e=!1){let t=Y(),s=r?.cwd??process.cwd(),n=Oe(s),o=r?.projects||[n],i=Mt();if(!i)return"";try{let a=o.length>1?be(i,o,t):z(i,n,t),d=o.length>1?he(i,o,t):Q(i,n,t);return a.length===0&&d.length===0?Lt(n,e):xt(n,a,d,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
