...
description: "Use OpenCode-Mem in Cursor with Google's free Gemini API"
---

# Cursor + Gemini Setup

This guide walks you through setting up OpenCode-Mem in Cursor using Google's Gemini API. Gemini offers a generous free tier that handles typical individual usage.
...
cat > ~/.opencode-mem/settings.json << 'EOF'
{
  ...
  "OPENCODE_MEM_GEMINI_API_KEY": "YOUR_GEMINI_API_KEY"
}
EOF
```
...
{
  "OPENCODE_MEM_PROVIDER": "gemini",
  "OPENCODE_MEM_GEMINI_API_KEY": "your-key",
  "OPENCODE_MEM_GEMINI_MODEL": "gemini-2.5-flash"
}
```
...
{
  "OPENCODE_MEM_PROVIDER": "gemini",
  "OPENCODE_MEM_GEMINI_API_KEY": "AIza..."
}
```
