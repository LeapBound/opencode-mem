...
**Issue:** [#591](https://github.com/thedotmack/opencode-mem/issues/591)
**Reporter:** cjdrilke
**Environment:** opencode-mem 9.0.0, Provider: openrouter, Model: xiaomi/mimo-v2-flash:free, Platform: linux
