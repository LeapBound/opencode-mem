    ...
    <div className="header">
      <h1>
        <div style={{ position: 'relative', display: 'inline-block' }}>
          <img src="opencode-mem-logomark.webp" alt="" className={`logomark ${isProcessing ? 'spinning' : ''}`} />
          {queueDepth > 0 && (
        ...
        <span className="logo-text">opencode-mem</span>
      </h1>
      <div className="status">
        <a
          href="https://docs.opencode-mem.ai"
          target="_blank"
        ...
        <GitHubStarsButton username="thedotmack" repo="opencode-mem" />
        <select
          value={currentFilter}
