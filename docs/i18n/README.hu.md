...
📚 **[Teljes dokumentáció megtekintése](https://docs.opencode-mem.ai/)** - Böngészés a hivatalos weboldalon

### Első lépések

- **[Telepítési útmutató](https://docs.opencode-mem.ai/installation)** - Gyors indítás és haladó telepítés
- **[Használati útmutató](https://docs.opencode-mem.ai/usage/getting-started)** - Hogyan működik automatikusan a OpenCode-Mem
- **[Keresési eszközök](https://docs.opencode-mem.ai/usage/search-tools)** - Projekt előzmények lekérdezése természetes nyelvvel
- **[Béta funkciók](https://docs.opencode-mem.ai/beta-features)** - Kísérleti funkciók, mint az Endless Mode kipróbálása

### Bevált gyakorlatok

- **[Kontextus tervezés](https://docs.opencode-mem.ai/context-engineering)** - AI ügynök kontextus optimalizálási elvek
- **[Progresszív felfedés](https://docs.opencode-mem.ai/progressive-disclosure)** - A OpenCode-Mem kontextus előkészítési stratégiájának filozófiája

### Architektúra

- **[Áttekintés](https://docs.opencode-mem.ai/architecture/overview)** - Rendszerkomponensek és adatfolyam
- **[Architektúra fejlődés](https://docs.opencode-mem.ai/architecture-evolution)** - Az út a v3-tól a v5-ig
- **[Hooks architektúra](https://docs.opencode-mem.ai/hooks-architecture)** - Hogyan használja a OpenCode-Mem az életciklus hookokat
- **[Hooks referencia](https://docs.opencode-mem.ai/architecture/hooks)** - 7 hook szkript magyarázata
- **[Worker szolgáltatás](https://docs.opencode-mem.ai/architecture/worker-service)** - HTTP API és Bun kezelés
- **[Adatbázis](https://docs.opencode-mem.ai/architecture/database)** - SQLite séma és FTS5 keresés
- **[Keresési architektúra](https://docs.opencode-mem.ai/architecture/search-architecture)** - Hibrid keresés Chroma vektor adatbázissal

### Konfiguráció és fejlesztés

- **[Konfiguráció](https://docs.opencode-mem.ai/configuration)** - Környezeti változók és beállítások
- **[Fejlesztés](https://docs.opencode-mem.ai/development)** - Építés, tesztelés, hozzájárulás
- **[Hibaelhárítás](https://docs.opencode-mem.ai/troubleshooting)** - Gyakori problémák és megoldások
...
További részletekért lásd az [Architektúra áttekintést](https://docs.opencode-mem.ai/architecture/overview).

---

## mem-search Skill

A OpenCode-Mem intelligens keresést biztosít a mem-search skillen keresztül, amely automatikusan aktiválódik, amikor múltbeli munkáról kérdez:
...
Részletes példákért lásd a [Keresési eszközök útmutatót](https://docs.opencode-mem.ai/usage/search-tools).

---

## Béta funkciók

A OpenCode-Mem **béta csatornát** kínál kísérleti funkciókkal, mint az **Endless Mode** (biomimetikus memória architektúra hosszabb munkamenetekhez). Váltson a stabil és béta verziók között a webes megjelenítő felületről a http://localhost:37777 → Settings címen.

További részletekért az Endless Mode-ról és annak kipróbálásáról lásd a **[Béta funkciók dokumentációt](https://docs.opencode-mem.ai/beta-features)**.
...
A beállítások a `~/.opencode-mem/settings.json` fájlban kezelhetők (automatikusan létrejön alapértelmezett értékekkel az első futtatáskor). Konfigurálható az AI modell, worker port, adatkönyvtár, naplózási szint és kontextus beillesztési beállítások.

Az összes elérhető beállításért és példákért lásd a **[Konfigurációs útmutatót](https://docs.opencode-mem.ai/configuration)**.

---

## Fejlesztés

Az építési utasításokért, tesztelésért és hozzájárulási munkafolyamatért lásd a **[Fejlesztési útmutatót](https://docs.opencode-mem.ai/development)**.
...
Gyakori problémákért és megoldásokért lásd a **[Hibaelhárítási útmutatót](https://docs.opencode-mem.ai/troubleshooting)**.
...
A hozzájárulási munkafolyamatért lásd a [Fejlesztési útmutatót](https://docs.opencode-mem.ai/development).
...
- **Hibák**: [GitHub Issues](https://github.com/thedotmack/opencode-mem/issues)
- **Tároló**: [github.com/thedotmack/opencode-mem](https://github.com/thedotmack/opencode-mem)
