...
- [ ] I searched [existing issues](https://github.com/thedotmack/opencode-mem/issues) and confirmed this is not a duplicate
...
- **Path**: `~/.opencode-mem/logs/worker-YYYY-MM-DD.log`
- **Example**: `~/.opencode-mem/logs/worker-2025-12-14.log`
