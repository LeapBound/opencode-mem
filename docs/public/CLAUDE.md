# OpenCode-Mem Public Documentation

## What This Folder Is

This `docs/public/` folder contains the **Mintlify documentation site** - the official user-facing documentation for opencode-mem. It's a structured documentation platform with a specific file format and organization.
...
**For contributors working on opencode-mem:**
