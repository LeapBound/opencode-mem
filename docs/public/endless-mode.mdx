...
```json
{
  "OPENCODE_MEM_ENDLESS_MODE": "false",  // Default: disabled
  "OPENCODE_MEM_ENDLESS_WAIT_TIMEOUT_MS": "90000"  // 90 second timeout
}
```
...
```bash
# Navigate to your opencode-mem installation
