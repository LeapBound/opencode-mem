...
**Output:** `~/Scripts/opencode-mem/actual_xml_only_with_timestamps.xml`
...
**Output:** `~/Scripts/opencode-mem/all_xml_fragments_with_timestamps.xml`
...
Scripts read from: `~/.claude/projects/-Users-alexnewman-Scripts-opencode-mem/*.jsonl`
