...
### Tag Strategy
- Wrap ONLY auto-generated content with `<opencode-mem-context>` tags
...
- `<opencode-mem-context>` tag is searchable fingerprint for GitHub analytics
...
4. Write to `<folder>/CLAUDE.md` preserving content outside `<opencode-mem-context>` tags
...
- [ ] Preserves content outside `<opencode-mem-context>` tags
...
<!-- This section is auto-generated by opencode-mem. Edit content outside the tags. -->
...
1. **Manual Test**:
   ...
   - Verify `<opencode-mem-context>` tags are present
