...
<p align="center">
  OpenCode-Mem משמר הקשר בצורה חלקה בין הפעלות על ידי לכידה אוטומטית של תצפיות על שימוש בכלים, יצירת סיכומים סמנטיים, והנגשתם להפעלות עתידיות. זה מאפשר ל-Claude לשמור על המשכיות של ידע על פרויקטים גם לאחר שהפעלות מסתיימות או מתחברות מחדש.
</p>
...
📚 **[צפה בתיעוד המלא](https://docs.opencode-mem.ai/)** - דפדף באתר הרשמי

### תחילת העבודה

- **[מדריך התקנה](https://docs.opencode-mem.ai/installation)** - התחלה מהירה והתקנה מתקדמת
- **[מדריך שימוש](https://docs.opencode-mem.ai/usage/getting-started)** - איך OpenCode-Mem עובד אוטומטית
- **[כלי חיפוש](https://docs.opencode-mem.ai/usage/search-tools)** - שאל את היסטוריית הפרויקט שלך בשפה טבעית
- **[תכונות בטא](https://docs.opencode-mem.ai/beta-features)** - נסה תכונות ניסיוניות כמו Endless Mode

### שיטות מומלצות

- **[הנדסת הקשר](https://docs.opencode-mem.ai/context-engineering)** - עקרונות אופטימיזציה של הקשר לסוכן AI
- **[גילוי מדורג](https://docs.opencode-mem.ai/progressive-disclosure)** - הפילוסופיה מאחורי אסטרטגיית הכנת ההקשר של OpenCode-Mem

### ארכיטקטורה

- **[סקירה כללית](https://docs.opencode-mem.ai/architecture/overview)** - רכיבי המערכת וזרימת הנתונים
- **[התפתחות הארכיטקטורה](https://docs.opencode-mem.ai/architecture-evolution)** - המסע מגרסה 3 לגרסה 5
- **[ארכיטקטורת Hooks](https://docs.opencode-mem.ai/hooks-architecture)** - איך OpenCode-Mem משתמש ב-lifecycle hooks
- **[מדריך Hooks](https://docs.opencode-mem.ai/architecture/hooks)** - 7 סקריפטי hook מוסברים
- **[שירות Worker](https://docs.opencode-mem.ai/architecture/worker-service)** - HTTP API וניהול Bun
- **[מסד נתונים](https://docs.opencode-mem.ai/architecture/database)** - סכמת SQLite וחיפוש FTS5
- **[ארכיטקטורת חיפוש](https://docs.opencode-mem.ai/architecture/search-architecture)** - חיפוש היברידי עם מסד נתוני וקטורים Chroma

### הגדרות ופיתוח

- **[הגדרות](https://docs.opencode-mem.ai/configuration)** - משתני סביבה והגדרות
- **[פיתוח](https://docs.opencode-mem.ai/development)** - בנייה, בדיקה, תרומה
- **[פתרון בעיות](https://docs.opencode-mem.ai/troubleshooting)** - בעיות נפוצות ופתרונות
...
ראה [סקירה כללית של הארכיטקטורה](https://docs.opencode-mem.ai/architecture/overview) לפרטים.

---

## מיומנות mem-search

OpenCode-Mem מספק חיפוש חכם דרך מיומנות mem-search שמופעלת אוטומטית כשאתה שואל על עבודה קודמת:
...
ראה [מדריך כלי חיפוש](https://docs.opencode-mem.ai/usage/search-tools) לדוגמאות מפורטות.

---

## תכונות בטא

OpenCode-Mem מציע **ערוץ בטא** עם תכונות ניסיוניות כמו **Endless Mode** (ארכיטקטורת זיכרון ביומימטית להפעלות מורחבות). החלף בין גרסאות יציבות ובטא מממשק הצופה האינטרנט ב-http://localhost:37777 → Settings.

ראה **[תיעוד תכונות בטא](https://docs.opencode-mem.ai/beta-features)** לפרטים על Endless Mode ואיך לנסות אותו.
...
ההגדרות מנוהלות ב-`~/.opencode-mem/settings.json` (נוצר אוטומטית עם ברירות מחדל בהפעלה הראשונה). הגדר מודל AI, פורט worker, ספריית נתונים, רמת לוג, והגדרות הזרקת הקשר.

ראה **[מדריך הגדרות](https://docs.opencode-mem.ai/configuration)** לכל ההגדרות הזמינות ודוגמאות.

---

## פיתוח

ראה **[מדריך פיתוח](https://docs.opencode-mem.ai/development)** להוראות בנייה, בדיקה, ותהליך תרומה.
...
ראה **[מדריך פתרון בעיות](https://docs.opencode-mem.ai/troubleshooting)** לבעיות נפוצות ופתרונות.
...
ראה [מדריך פיתוח](https://docs.opencode-mem.ai/development) לתהליך תרומה.
...
- **תיעוד**: [docs/](docs/)
- **בעיות**: [GitHub Issues](https://github.com/thedotmack/opencode-mem/issues)
- **מאגר**: [github.com/thedotmack/opencode-mem](https://github.com/thedotmack/opencode-mem)
