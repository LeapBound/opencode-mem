...
description: "System components and data flow in OpenCode-Mem"
---
...
OpenCode-Mem operates as a Claude Code plugin with five core components:
...
- Location: `~/.opencode-mem/opencode-mem.db`
