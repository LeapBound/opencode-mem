...
4118969 1     161656   07:28:16  bun ~/.claude/plugins/cache/thedotmack/opencode-mem/9.0.0/scripts/worker-service.cjs --daemon
```
...
1. Use opencode-mem normally throughout a work session
...
The opencode-mem worker service uses a modular architecture:
...
- **Issue:** https://github.com/thedotmack/opencode-mem/issues/603
- **Source Files:**
