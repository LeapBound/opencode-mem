...
📚 **[Xem Tài Liệu Đầy Đủ](https://docs.opencode-mem.ai/)** - Duyệt trên trang web chính thức

### Bắt Đầu

- **[Hướng Dẫn Cài Đặt](https://docs.opencode-mem.ai/installation)** - Bắt đầu nhanh & cài đặt nâng cao
- **[Hướng Dẫn Sử Dụng](https://docs.opencode-mem.ai/usage/getting-started)** - Cách OpenCode-Mem hoạt động tự động
- **[Công Cụ Tìm Kiếm](https://docs.opencode-mem.ai/usage/search-tools)** - Truy vấn lịch sử dự án bằng ngôn ngữ tự nhiên
- **[Tính Năng Beta](https://docs.opencode-mem.ai/beta-features)** - Dùng thử các tính năng thử nghiệm như Endless Mode

### Thực Hành Tốt Nhất

- **[Kỹ Thuật Ngữ Cảnh](https://docs.opencode-mem.ai/context-engineering)** - Các nguyên tắc tối ưu hóa ngữ cảnh cho AI agent
- **[Tiết Lộ Tuần Tự](https://docs.opencode-mem.ai/progressive-disclosure)** - Triết lý đằng sau chiến lược chuẩn bị ngữ cảnh của OpenCode-Mem

### Kiến Trúc

- **[Tổng Quan](https://docs.opencode-mem.ai/architecture/overview)** - Các thành phần hệ thống & luồng dữ liệu
- **[Phát Triển Kiến Trúc](https://docs.opencode-mem.ai/architecture-evolution)** - Hành trình từ v3 đến v5
- **[Kiến Trúc Hooks](https://docs.opencode-mem.ai/hooks-architecture)** - Cách OpenCode-Mem sử dụng lifecycle hooks
- **[Tham Chiếu Hooks](https://docs.opencode-mem.ai/architecture/hooks)** - Giải thích 7 hook scripts
- **[Worker Service](https://docs.opencode-mem.ai/architecture/worker-service)** - HTTP API & quản lý Bun
- **[Cơ Sở Dữ Liệu](https://docs.opencode-mem.ai/architecture/database)** - Schema SQLite & tìm kiếm FTS5
- **[Kiến Trúc Tìm Kiếm](https://docs.opencode-mem.ai/architecture/search-architecture)** - Tìm kiếm kết hợp với cơ sở dữ liệu vector Chroma

### Cấu Hình & Phát Triển

- **[Cấu Hình](https://docs.opencode-mem.ai/configuration)** - Biến môi trường & cài đặt
- **[Phát Triển](https://docs.opencode-mem.ai/development)** - Xây dựng, kiểm thử, đóng góp
- **[Khắc Phục Sự Cố](https://docs.opencode-mem.ai/troubleshooting)** - Các vấn đề thường gặp & giải pháp
...
Xem [Tổng Quan Kiến Trúc](https://docs.opencode-mem.ai/architecture/overview) để biết chi tiết.

---

## mem-search Skill

OpenCode-Mem cung cấp tìm kiếm thông minh thông qua kỹ năng mem-search tự động kích hoạt khi bạn hỏi về công việc trước đây:
...
Xem [Hướng Dẫn Công Cụ Tìm Kiếm](https://docs.opencode-mem.ai/usage/search-tools) để biết các ví dụ chi tiết.

---

## Tính Năng Beta

OpenCode-Mem cung cấp **kênh beta** với các tính năng thử nghiệm như **Endless Mode** (kiến trúc bộ nhớ sinh học mô phỏng cho các phiên mở rộng). Chuyển đổi giữa các phiên bản ổn định và beta từ giao diện web viewer tại http://localhost:37777 → Settings.

Xem **[Tài Liệu Tính Năng Beta](https://docs.opencode-mem.ai/beta-features)** để biết chi tiết về Endless Mode và cách dùng thử.
...
Cài đặt được quản lý trong `~/.opencode-mem/settings.json` (tự động tạo với giá trị mặc định khi chạy lần đầu). Cấu hình mô hình AI, cổng worker, thư mục dữ liệu, mức độ log và cài đặt chèn ngữ cảnh.

Xem **[Hướng Dẫn Cấu Hình](https://docs.opencode-mem.ai/configuration)** để biết tất cả các cài đặt và ví dụ có sẵn.

---

## Phát Triển

Xem **[Hướng Dẫn Phát Triển](https://docs.opencode-mem.ai/development)** để biết hướng dẫn xây dựng, kiểm thử và quy trình đóng góp.
...
Xem **[Hướng Dẫn Khắc Phục Sự Cố](https://docs.opencode-mem.ai/troubleshooting)** để biết các vấn đề thường gặp và giải pháp.
...
Xem [Hướng Dẫn Phát Triển](https://docs.opencode-mem.ai/development) để biết quy trình đóng góp.
...
- **Tài Liệu**: [docs/](docs/)
- **Vấn Đề**: [GitHub Issues](https://github.com/thedotmack/opencode-mem/issues)
