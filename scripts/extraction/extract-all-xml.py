...
transcript_dir = os.path.expanduser('~/.claude/projects/-Users-alexnewman-Scripts-opencode-mem/')
...
output_file = os.path.expanduser('~/Scripts/opencode-mem/all_xml_fragments_with_timestamps.xml')
