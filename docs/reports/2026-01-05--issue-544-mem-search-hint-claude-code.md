...
**Date:** 2026-01-05
**Issue:** https://github.com/thedotmack/opencode-mem/issues/544
...
**File:** `/Users/alexnewman/Scripts/opencode-mem/src/services/context/formatters/MarkdownFormatter.ts`
...
**File:** `/Users/alexnewman/Scripts/opencode-mem/src/services/context/formatters/ColorFormatter.ts`
...
**File:** `/Users/alexnewman/Scripts/opencode-mem/src/services/context/formatters/MarkdownFormatter.ts` (lines 70-79)
...
**File:** `/Users/alexnewman/Scripts/opencode-mem/src/services/context/formatters/ColorFormatter.ts` (lines 72-81)
...
**File:** `/Users/alexnewman/Scripts/opencode-mem/src/services/context/sections/FooterRenderer.ts`
...
**File:** `/Users/alexnewman/Scripts/opencode-mem/plugin/.mcp.json`
```json
{
  "mcpServers": {
    "mcp-search": {
...
**Path:** `/Users/alexnewman/Scripts/opencode-mem/plugin/skills/`

```
skills/
  opencode-mem-settings/  (empty)
  mem-search/
    operations/  (empty)
    principles/  (empty)
  search/
...
---
name: mem-search
description: Search opencode-mem memory database using MCP tools
---
