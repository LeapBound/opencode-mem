...
### Location
`/Users/alexnewman/Scripts/opencode-mem/src/services/worker/SessionManager.ts`
...
Looking at `/Users/alexnewman/Scripts/opencode-mem/src/services/worker/http/routes/SessionRoutes.ts` (lines 213-216), the session completion handling has this comment:
...
### Location
`/Users/alexnewman/Scripts/opencode-mem/src/services/worker-types.ts` (line 34)
...
1. **SDKAgent** (`/Users/alexnewman/Scripts/opencode-mem/src/services/worker/SDKAgent.ts`)
   - Adds user messages at lines 247, 280, 302
   - Assistant responses added via `ResponseProcessor`

2. **GeminiAgent** (`/Users/alexnewman/Scripts/opencode-mem/src/services/worker/GeminiAgent.ts`)
   - Adds user messages at lines 143, 196, 232
   - Adds assistant responses at lines 148, 202, 238

3. **OpenRouterAgent** (`/Users/alexnewman/Scripts/opencode-mem/src/services/worker/OpenRouterAgent.ts`)
...
4. **ResponseProcessor** (`/Users/alexnewman/Scripts/opencode-mem/src/services/worker/agents/ResponseProcessor.ts`)
...
private truncateHistory(history: ConversationMessage[]): ConversationMessage[] {
  const MAX_CONTEXT_MESSAGES = parseInt(settings.OPENCODE_MEM_OPENROUTER_MAX_CONTEXT_MESSAGES) || 20;
  const MAX_ESTIMATED_TOKENS = parseInt(settings.OPENCODE_MEM_OPENROUTER_MAX_TOKENS) || 100000;
...
**File**: `/Users/alexnewman/Scripts/opencode-mem/src/services/worker/SessionManager.ts`
...
**Files**:
- `/Users/alexnewman/Scripts/opencode-mem/src/services/worker/SDKAgent.ts`
- `/Users/alexnewman/Scripts/opencode-mem/src/services/worker/GeminiAgent.ts`
- `/Users/alexnewman/Scripts/opencode-mem/src/services/worker/agents/ResponseProcessor.ts`
...
**File**: `/Users/alexnewman/Scripts/opencode-mem/src/services/worker/http/routes/SessionRoutes.ts`
...
```json
{
  "OPENCODE_MEM_SESSION_TTL_MINUTES": 60,
  "OPENCODE_MEM_MAX_CONVERSATION_HISTORY": 50,
  "OPENCODE_MEM_MAX_ACTIVE_SESSIONS": 100
}
```
